# Microsoft 365 Mail (Agent365)

Microsoft's Agent365 Mail MCP server. Exposes tools to create, send, reply to,
update, delete, and search email messages through the Microsoft Graph Mail APIs.

## Transport

**http** — the agent connects to
`https://agent365.svc.cloud.microsoft/agents/tenants/${MICROSOFT_TENANT_ID}/servers/mcp_MailTools`
