# SharePoint Lists (Agent365)

Microsoft's Agent365 SharePoint Lists MCP server. Exposes tools to create, read,
update, and query SharePoint list items and columns through the Microsoft Graph
APIs.

## Transport

**http** — the agent connects to
`https://agent365.svc.cloud.microsoft/agents/tenants/${MICROSOFT_TENANT_ID}/servers/mcp_SharePointListsTools`
...
- Endpoint: `https://agent365.svc.cloud.microsoft/agents/tenants/{tenant_id}/servers/mcp_SharePointListsTools`
