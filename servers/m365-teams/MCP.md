# Microsoft Teams (Agent365)

Microsoft's Agent365 Teams MCP server. Exposes tools to work with Teams chats,
channels, and messages through the Microsoft Graph APIs.

## Transport

**http** — the agent connects to
`https://agent365.svc.cloud.microsoft/agents/tenants/${MICROSOFT_TENANT_ID}/servers/mcp_TeamsServer`
