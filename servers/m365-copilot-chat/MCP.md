# Microsoft 365 Copilot Chat (Agent365)

Microsoft's Agent365 Copilot Chat MCP server. Exposes tools to search and
retrieve across your Microsoft 365 content — documents, emails, sites, files,
and chats — grounded in your tenant through the Microsoft 365 Copilot APIs.

## Transport

**http** — the agent connects to
`https://agent365.svc.cloud.microsoft/agents/tenants/${MICROSOFT_TENANT_ID}/servers/mcp_M365Copilot`
