# Microsoft 365 Calendar (Agent365)

Microsoft's Agent365 Calendar MCP server. Exposes tools to create, update, and
delete calendar events, manage meeting invites, and check attendee availability
through the Microsoft Graph Calendar APIs.

## Transport

**http** — the agent connects to
`https://agent365.svc.cloud.microsoft/agents/tenants/${MICROSOFT_TENANT_ID}/servers/mcp_CalendarTools`
